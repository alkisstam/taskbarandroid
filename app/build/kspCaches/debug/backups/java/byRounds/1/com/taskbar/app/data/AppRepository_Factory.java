...
public final class AppRepository_Factory implements Factory<AppRepository> {
  ...
  public static AppRepository_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new AppRepository_Factory(Providers.asDaggerProvider(contextProvider));
  }
