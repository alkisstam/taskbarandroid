...
public final class OverlayService_MembersInjector implements MembersInjector<OverlayService> {
  ...
  public OverlayService_MembersInjector(Provider<AppRepository> appRepositoryProvider,
  ...
  public static MembersInjector<OverlayService> create(
      ...
      javax.inject.Provider<QuickControlsRepository> quickControlsRepositoryProvider) {
    return new OverlayService_MembersInjector(Providers.asDaggerProvider(appRepositoryProvider), Providers.asDaggerProvider(prefsRepositoryProvider), Providers.asDaggerProvider(quickControlsRepositoryProvider));
  }
